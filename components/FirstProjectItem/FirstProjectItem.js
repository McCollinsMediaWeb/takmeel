...
export default function FirstProjectItem({
    ...
    return (
        ...
        <div className={`FullScreenBanner Projects phase-${phase}`}>
            {backgroundVideo ? (
                <video
                    src={`/${backgroundVideo}`}
                    autoPlay
                ...
                <div className="FsBannerContentFlex centerBlock">
                    <div className="container">
                        <div>
                            ...
                            <div className="Txt2 text-uppercase TxtBig">{text2}</div>

                            {phase === "final" && (
                                <div className="final-content">
                                    <div className="Txt1">{text1}</div>
                                    <div className="Txt2 text-uppercase final-txt2">Crafted for Inspired Living</div>
                                    <div className="Txt3 nunito-text SmallSizeTxt">{text3}</div>
