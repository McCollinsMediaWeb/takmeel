                        ...
                        >
                            <div className="row align-items-center">
                                ...
                                <div className="col-md-8">
                                    ...
                                    <div className="CfT1 nunito-text contact-email">asad.bashir@takmeeldevelopment.com</div>
                        ...
                        >
                            <div className="row align-items-center second">
                                ...
                                <div className="col-md-8">
                                    ...
                                    <div className="CfT1 nunito-text contact-email">tariq.ali@takmeeldevelopment.com</div>
                                    <div className="BlT3">
