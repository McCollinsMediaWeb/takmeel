...
export default function GolfViewLivingApartmentsClient() {
    ...
    const DataProjectDetails1 = {
        text1: t('GolfViewLivingApartment.amenitiesSection.subTitle'),
        text2: t('GolfViewLivingApartment.amenitiesSection.title'),
        text3: t('GolfViewLivingApartment.amenitiesSection.content'),
        GalleryImages: [
    ...
    const DataProjectDetails2 = {
        ...
        text1Heading: t('GolfViewLivingApartment.projectDetailsSection.title1'),
        text1Desc: t('GolfViewLivingApartment.projectDetailsSection.content1'),
        text2Heading: t('GolfViewLivingApartment.projectDetailsSection.title2'),
        text2Desc: t('GolfViewLivingApartment.projectDetailsSection.content2'),
    };
    ...
    const DataProjectDetails4 = {
        text1: t('GolfViewLivingApartment.interiorSection.subTitle'),
        text2: t('GolfViewLivingApartment.interiorSection.title'),
        text3: t('GolfViewLivingApartment.interiorSection.content'),
    ...
    const DataProjectDetails7 = {
        ...
        text1: t('GolfViewLivingApartment.mapSection.title'),
        text2: t('GolfViewLivingApartment.mapSection.content'),
        landmarks: [
            "Al Zorah Ajman",
    ...
    return (
        ...
        <div>
            ...
            <ProjectDetails7 mapimage="golf-apartments-desktop.jpg" mobileMapImage="golf-apartments-mobile.jpg" {...DataProjectDetails7} />
            {/* <CostCalculator /> */}
