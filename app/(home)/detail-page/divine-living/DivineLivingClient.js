...
export default function DivineLivingClient() {
    const t = useTranslations('Properties');
    const detailHeroData = {
        backgroundImage: "bannerDesktopFirst.jpg",
        backgroundImageMobile: "bannerMobileFirst.jpg",
        text1: t('DivineLiving.content'),
        text2: t('DivineLiving.title'),
        text3: t('DivineLiving.subTitle'),
    ...
    const DataProjectDetails1 = {
        text1: t('DivineLiving.amenitiesSection.subTitle'),
        text2: t('DivineLiving.amenitiesSection.title'),
        text3: t('DivineLiving.amenitiesSection.content'),
        GalleryImages: [
            "s1.jpg",
            "s2.jpg",
            "s3.jpg",
    ...
    const DataProjectDetails2 = {
        ...
        text1Heading: t('DivineLiving.projectDetailsSection.title1'),
        text1Desc: t('DivineLiving.projectDetailsSection.content1'),
        text2Heading: t('DivineLiving.projectDetailsSection.title2'),
        text2Desc: t('DivineLiving.projectDetailsSection.content2'),
    };
    ...
    const DataProjectDetails4 = {
        text1: t('DivineLiving.interiorSection.subTitle'),
        text2: t('DivineLiving.interiorSection.title'),
        text3: t('DivineLiving.interiorSection.content'),
    ...
    const DataProjectDetails7 = {
        text1: t('DivineLiving.mapSection.title'),
        text2: t('DivineLiving.mapSection.content'),
        landmarks: [
            // "Central Location",
