...
export default function Projects() {
  return (
    <section>
      ...
      <ProjectItem backgroundImage="meydan.webp" backgroundImageMobile="meydan-mobile.jpg" text1="Featured Properties"  text2="Meydan Racecourse Mansion" text3="Dubai" tagline="Where Grandeur Meets Precision" url="meydan-racecourse-mansion" />
