...
export default function GolfViewLivingApartments() {
    return (
        <div>
            <DetailHero backgroundImage="main1.jpg" backgroundImageMobile="main1mobile.jpg" text1="Featured Properties" text2="Golf View Living Apartments" text3="Al Zorah, Ajman" />
            <ProjectDetails1 />
