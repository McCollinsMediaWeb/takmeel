  ...
  return (
    <div>
      <div>
        ...
        <FullScreenBanner backgroundImage="Divine-Residencia-Video.mp4" backgroundImageMobile="main2mobile.jpg" text1="Featured Properties"  text2="Divine Residencia" text3="Dubai Studio City, Dubai" tagline="Where Comfort Meets Contemporary Elegance" url="divine-residencia" />
        ...
        <FullScreenBanner backgroundImage="golf-villas.jpg" backgroundImageMobile="golf-villas.jpg" text1="Featured Properties"  text2="Golf View Living Villas" text3="Ajman" tagline="Private Villas Surrounded by Nature’s Calm" url="golf-view-living-villas" />
        ...
        <FullScreenBanner backgroundImage="divine-residence.jpg" backgroundImageMobile="divine-residence.jpg" text1="Featured Properties"  text2="Divine Residencies" text3="Dubai" tagline="Smart Spaces Crafted for Modern Lifestyles" url="divine-residencies" />
