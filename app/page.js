  ...
  return (
    <div>
      <div>
        ...
        <FullScreenBanner backgroundImage="divinresdesk.mp4" backgroundImageMobile="divinresmobile.mp4" text1="Featured Properties"  text2="Divine Residencia" text3="Dubai Studio City, Dubai" tagline="Where Comfort Meets Contemporary Elegance" url="divine-residencia" />
