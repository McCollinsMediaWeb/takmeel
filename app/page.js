  ...
  return (
    <div>
      <div>
        ...
        <FullScreenBanner backgroundImage="main1.jpg" backgroundImageMobile="main1mobile.jpg" text1="Now Unveiling"  text2="Takmeel Al Barari View Properties" text3="Majan, Dubai" tagline="Urban Living, Reimagined by Nature" url="takmeel-al-barari-view-properties" />
        ...
        <FullScreenBanner backgroundImage="Divine-Residencia-Video.mp4" backgroundImageMobile="Divine-Residencia-Video.mp4" text1="Featured Properties"  text2="Divine Residencia" text3="Dubai Studio City, Dubai" tagline="Where Comfort Meets Contemporary Elegance" url="divine-residencia" />
        ...
        <FullScreenBanner backgroundImage="Divine-Golf-Video.mp4" backgroundImageMobile="Divine-Golf-Video.mp4" text1="Featured Properties"  text2="Golf View Living Apartments" text3="Al Zorah, Ajman" tagline="Your Everyday Escape, Overlooking the Greens" url="golf-view-living-apartments" />
